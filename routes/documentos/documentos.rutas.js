...
router.delete('/eliminar', async (req, res) => {
    ...
    if (!key) {
        return res.status(400).json({ error: 'Falta el parámetro "key" en el cuerpo de la solicitud' });
    }
    ...
    try {
        ...
        res.status(500).json({ error: 'No se pudo eliminar el archivo', detalle: error.message });
    }
});
